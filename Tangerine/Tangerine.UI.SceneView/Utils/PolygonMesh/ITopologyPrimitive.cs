...
//	{
//		bool HitTest(Vector2 position, out float distance, Vector2 contextSize, float scale = 1.0f);
//		void Translate(Vector2 positionDelta);
//		void TranslateUV(Vector2 uvDelta);
//		void Render(Matrix32 transform, Vector2 contextSize);
//		void RenderHovered(Matrix32 transform, PolygonMeshManager.ModificationState state, Vector2 creationHintPosition, Vector2 contextSize);
...
//		public bool HitTest(Vector2 position, out float distance, Vector2 contextSize, float scale = 1.0f)
//		{
...
//		public void Render(Matrix32 transform, Vector2 contextSize)
//		{
...
//		public void RenderHovered(Matrix32 transform, PolygonMeshManager.ModificationState state, Vector2 creationHintPosition, Vector2 contextSize)
//		{
//			PolygonMeshUtils.RenderVertex(
//				transform.TransformVector(Topology.Vertices[TopologicalIndex].Pos * contextSize),
...
//		{
//			return
//				(TopologicalIndex0, TopologicalIndex1).GetHashCode() +
//				(TopologicalIndex1, TopologicalIndex0).GetHashCode();
//		}
//	}
...
//			var p0 = Topology.Vertices[TopologicalIndex0].Pos * contextSize;
//			var p1 = Topology.Vertices[TopologicalIndex1].Pos * contextSize;
//			var p2 = Topology.Vertices[TopologicalIndex2].Pos * contextSize;
...
//				transform.TransformVector(Topology.Vertices[TopologicalIndex0].Pos * contextSize),
//				transform.TransformVector(Topology.Vertices[TopologicalIndex1].Pos * contextSize),
//				transform.TransformVector(Topology.Vertices[TopologicalIndex2].Pos * contextSize),
//				state == PolygonMeshManager.ModificationState.Removal ? Theme.Colors.PolygonMeshRemovalColor : Theme.Colors.PolygonMeshHoverColor
//			);
//			if (state == PolygonMeshManager.ModificationState.Creation) {
//				PolygonMeshUtils.RenderVertex(
