...
namespace Tangerine.UI
{
	public static class TimelineCommands
	{
		...
		public static readonly ICommand EnterNode = new Command("Enter Node", new Shortcut(Key.Enter)) { Repeatable = false };
		...
		public static readonly ICommand DeleteMarkersInRange = new Command("Delete Markers in range");
	...
	public static class InspectorCommands
	{
		...
		public static readonly ICommand CopyAssetPath = new Command("Copy Asset Path") { Icon = IconPool.GetIcon("Inspector.CopyAssetPath") };
	}
	...
	public static class GenericCommands
	{
		...
		public static readonly ICommand NewTan = new Command("New Scene", new Shortcut(Modifiers.Command, Key.N));
	...
	public static class Tools
	{
		...
		public static readonly ICommand PolygonMeshAnimate = new Command("Animate Mesh") { Icon = IconPool.GetIcon("Tools.ToolsCenterView") };
