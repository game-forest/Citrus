...
namespace Tangerine.UI
{
	public static class TimelineCommands
	{
		...
		public static readonly ICommand AddAnimation = new Command("Add Animation");
		public static readonly ICommand AddCompoundAnimation = new Command("Add Compound Animation");
		public static readonly ICommand AddZeroPoseAnimation = new Command("Add ZeroPose Animation");
	}
