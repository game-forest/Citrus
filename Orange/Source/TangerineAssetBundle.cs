...
namespace Tangerine.Core
{
	public class TangerineAssetBundle : UnpackedAssetBundle
	{
		...
		private static AssetBundle OpenCacheBundle(AssetBundleFlags flags = AssetBundleFlags.None)
		{
		...
		private static string GetFbxPathFromAnimationPath(string animationPath)
		{
